...
/**
 * This interface is a placeholder for future expansion of compression support requiring a separate
 * compression package with implemntations for BZip2, LZMA etc.
 *
...
interface Compression {
     ...
     * all ByteBuffers provided must contain entire compressed payload. Indicate end of input with a buffer that
     * has remaining == 0 (!hasRemaining) indicating an empty buffer.
     ...
     * ByteBuffers
     * @param input will be invoked once for each input required.  Total size (sum of array sizes) of
     * all arrays provided must contain entire compressed payload. Indicate end of input with an empty array.
     ...
     * payloads with high compression ratios, this function may be called many more times than the
     * [input] function.
