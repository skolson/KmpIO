...
class TimeTests {
    ...
    fun timeTest() {
        ...
        ZipTime(LocalDateTime(2017, 6, 23, 18, 46, s)).apply {
            ...
            assertEquals(cal.get(Calendar.MONTH) + 1, zipTime.monthNumber)
            assertEquals(cal.get(Calendar.DAY_OF_MONTH), zipTime.dayOfMonth)
            ...
            assertEquals(cal2.get(Calendar.MONTH) + 1, zipTime.monthNumber)
            assertEquals(cal2.get(Calendar.DAY_OF_MONTH), zipTime.dayOfMonth)
